...
function Wrapper({ content } : FileBlockProps) {
  ...
  return (
    ...
    >
      ...
      <h2 className={tw(`text-2xl font-medium mb-4`)}>Colors</h2>
      <div className={tw(`grid grid-cols-2 lg:grid-cols-3 min-w-[27em] max-w-[50em] mt-6`)}>
        ...
        <div className={tw(`w-full flex flex-col m-2`)}>
          <h2 className={tw(`text-2xl font-medium mb-4`)}>Fonts</h2>
            ...
            {fonts.map(([name, value]) => {
              return (
                <div className={tw(`flex-1 flex flex-col my-2 mr-10 max-w-[20em]`)}>
                  ...
                  <p className={tw(`flex flex-wrap mt-1 text-xl pt-3`)} style={{
                    fontFamily: value,
                  }}>
                    {letters.map(char => (
